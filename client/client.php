	...
	?>
		<script type="text/javascript">
			var clientvars = {
				...
				"connection.info.host": window.ohabbo.host,
				"connection.info.port": window.ohabbo.port,
				"site.url": "<?= URL; ?>",
				"url.prefix": "<?= URL; ?>",
				...
				"external.variables.txt": "<?= $Hotel::Settings('external_variables'); ?>?v=7",
...
<?php } ?>
			...
			swfobject.embedSWF('<?= $Hotel::Settings('flash_client_url'); ?>/Habbo.swf?v=1', 'flash-container', '100%', '100%', '11.1.0', 'expressInstall.swf', clientvars, params, null, null);
		</script>
		<script src="<?= CDN; ?>/assets/js/habboapi.js"></script>
		<!--<script src="<?= CDN; ?>/assets/js/radio.js"></script>-->
	<?php 
			} 
		}
	?>
