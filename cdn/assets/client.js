window.onbeforeunload = function (e) {
    ...
    if (e) {
        e.returnValue = 'Are you sure you want to close Lella?';
    }

    // For Safari
    return 'Are you sure you want to close Lella?';
};
...
(function() {
    ...
    Client = {
        ...
        notification: function(label) {
            ...
            $(
                ...
                '           <img alt="' + label[1] + '" src="https://habbo.city/habbo-imaging/avatarimage?figure=' + label[2] + '&headonly=0&size=n&gesture=sml&direction=2&head_direction=3&action=wav">' + '\n' +
                '       </div>' + '\n' +
                '       <div class="client-notification-content flex-column">' + '\n' +
                '           <div class="client-notification-content-info flex padding-min gray-clear">' + '\n' +
                '               <h5 class="client-notification-content-username">' + label[1] + '</h5>' + '\n' +
                '           </div>' + '\n' +
                ...
                '</div>'
            ).appendTo('.client-notification > .client-notification-area').find('h6').text(decode_utf8(mentionMessage));
    ...
    $(document).on('click', '.client-unfreeze', function() {
    	var theClient = $('#flash-container'),
    	theWidth = theClient.width();
    ...
    $(document).on('click', '.client-expand', function() {
